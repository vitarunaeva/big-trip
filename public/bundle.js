...
/*!**************************!*\
  !*** ./src/api/index.js ***!
  \**************************/
/*! exports provided: Method, SuccessHTTPStatusRange, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class Api {
  ...
  getPoints() {
    return this._load({url: `points`})
      .then(Api.toJSON)
      .then((points) => points.map(_model_points_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient));
  }

  getDestinations() {
    return this._load({url: `destinations`})
      .then(Api.toJSON)
      .then((destinations) => destinations.map(_model_destinations_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToClient));
  }
  ...
  getOffers() {
    return this._load({url: `offers`})
      .then(Api.toJSON)
      .then((offers) => {
        return offers.map(_model_offers_js__WEBPACK_IMPORTED_MODULE_2__["default"].adaptToClient);
      });
  }
  ...
  updatePoint(point) {
    return this._load({
      url: `points/${point.id}`,
      method: Method.PUT,
      body: JSON.stringify(_model_points_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(point)),
      headers: new Headers({"Content-Type": `application/json`})
    })
      .then(Api.toJSON)
      .then(_model_points_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient);
  }
...
/* harmony import */ var _utils_random_integer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/random-integer.js */ "./src/utils/random-integer.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _model_points_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../model/points.js */ "./src/model/points.js");
/* harmony import */ var _model_destinations_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../model/destinations.js */ "./src/model/destinations.js");
/* harmony import */ var _model_offers_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../model/offers.js */ "./src/model/offers.js");
  ...
  getPoints() {
    if (Provider._isOnline()) {
      return this._api.getPoints()
        .then((points) => {
          const items = createStoreStructure(points.map(_model_points_js__WEBPACK_IMPORTED_MODULE_3__["default"].adaptToServer));
    ...
    if (!Provider._isOnline()) {
      storePoints.forEach((point) => {
        point.destination.pictures = point.destination.pictures.map((picture) => {
          return {src: `/img/photos/${Object(_utils_random_integer_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(1, 5)}.jpg`, description: picture.description};
        });
      });
    }
    return Promise.resolve(storePoints.map(_model_points_js__WEBPACK_IMPORTED_MODULE_3__["default"].adaptToClient));
  }
  ...
  getDestinations() {
    if (Provider._isOnline()) {
      return this._api.getDestinations()
        .then((destinations) => {
          const items = destinations.map(_model_destinations_js__WEBPACK_IMPORTED_MODULE_4__["default"].adaptToServer);
          this._store.setIndividualItem(_const_js__WEBPACK_IMPORTED_MODULE_2__["StorageType"].DESTINATIONS_STORAGE, items);
          return destinations;
        });
    }

    const storeDestinations = Object.values(this._store.getIndividualItem(_const_js__WEBPACK_IMPORTED_MODULE_2__["StorageType"].DESTINATIONS_STORAGE));
    ...
    return Promise.resolve(storeDestinations.map(_model_destinations_js__WEBPACK_IMPORTED_MODULE_4__["default"].adaptToClient));
  }
  ...
  getOffers() {
    if (Provider._isOnline()) {
      return this._api.getOffers()
        .then((offers) => {
          const items = offers.map(_model_offers_js__WEBPACK_IMPORTED_MODULE_5__["default"].adaptToServer);
          this._store.setIndividualItem(_const_js__WEBPACK_IMPORTED_MODULE_2__["StorageType"].OFFERS_STORAGE, items);
          return offers;
        });
    }

    const storeOffers = Object.values(this._store.getIndividualItem(_const_js__WEBPACK_IMPORTED_MODULE_2__["StorageType"].OFFERS_STORAGE));

    return Promise.resolve(storeOffers.map(_model_offers_js__WEBPACK_IMPORTED_MODULE_5__["default"].adaptToClient));
  }
  ...
  updatePoint(point) {
    if (Provider._isOnline()) {
      return this._api.updatePoint(point)
        .then((updatedPoint) => {
          this._store.setItem(updatedPoint.id, _model_points_js__WEBPACK_IMPORTED_MODULE_3__["default"].adaptToServer(updatedPoint));
          return updatedPoint;
        });
    }

    this._store.setItem(point.id, _model_points_js__WEBPACK_IMPORTED_MODULE_3__["default"].adaptToServer(Object.assign({}, point)));
  ...
  addPoint(point) {
    if (Provider._isOnline()) {
      return this._api.addPoint(point)
        .then((newPoint) => {
          this._store.setItem(newPoint.id, _model_points_js__WEBPACK_IMPORTED_MODULE_3__["default"].adaptToServer(newPoint));
          return newPoint;
        });
    }

    const localNewPointId = Object(nanoid__WEBPACK_IMPORTED_MODULE_0__["nanoid"])();
    const localNewPoint = Object.assign({}, point, {id: localNewPointId});

    this._store.set(localNewPoint.id, _model_points_js__WEBPACK_IMPORTED_MODULE_3__["default"].adaptToServer(localNewPoint));
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: MoveType, ActivityType, EVENT_TYPE, PostfixType, MAX_OFFERS, POINT_ID, SortType, FilterType, NEW_EVENT, RenderPosition, PointMode, UserAction, UpdateType, StatisticsType, TabNavItem, TabAdditionalItem, MenuItem, MessageText, State, StorageType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PostfixType", function() { return PostfixType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAX_OFFERS", function() { return MAX_OFFERS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "POINT_ID", function() { return POINT_ID; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PointMode", function() { return PointMode; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TabNavItem", function() { return TabNavItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TabAdditionalItem", function() { return TabAdditionalItem; });
...
const EVENT_TYPE = Object.assign({}, MoveType, ActivityType);
...
const TabAdditionalItem = {
  ADD_NEW_EVENT: `ADD_NEW_EVENT`,
};

const MenuItem = Object.assign({}, TabNavItem, TabAdditionalItem);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _presenter_event_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./presenter/event.js */ "./src/presenter/event.js");
...
/* harmony import */ var _api_provider_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api/provider.js */ "./src/api/provider.js");
/* harmony import */ var _presenter_trip_info_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./presenter/trip-info.js */ "./src/presenter/trip-info.js");
/* harmony import */ var _presenter_menu_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./presenter/menu.js */ "./src/presenter/menu.js");
/* harmony import */ var _presenter_statistics_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./presenter/statistics.js */ "./src/presenter/statistics.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./const.js */ "./src/const.js");
/* harmony import */ var _model_menu__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./model/menu */ "./src/model/menu.js");
/* harmony import */ var _model_destinations__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./model/destinations */ "./src/model/destinations.js");
/* harmony import */ var _model_offers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./model/offers */ "./src/model/offers.js");
/* harmony import */ var _model_points__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./model/points */ "./src/model/points.js");
/* harmony import */ var _model_new_point__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./model/new-point */ "./src/model/new-point.js");
/* harmony import */ var _model_filter__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./model/filter */ "./src/model/filter.js");
...
const api = new _api_index_js__WEBPACK_IMPORTED_MODULE_1__["default"](END_POINT, AUTHORIZATION);

const store = new _api_store_js__WEBPACK_IMPORTED_MODULE_2__["default"](STORE_NAME, localStorage);
const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_3__["default"](api, store);

const menuModel = new _model_menu__WEBPACK_IMPORTED_MODULE_8__["default"]();
const destinationsModel = new _model_destinations__WEBPACK_IMPORTED_MODULE_9__["default"]();
const offersModel = new _model_offers__WEBPACK_IMPORTED_MODULE_10__["default"]();
const pointsModel = new _model_points__WEBPACK_IMPORTED_MODULE_11__["default"]();
const newPointModel = new _model_new_point__WEBPACK_IMPORTED_MODULE_12__["default"]();
const filterModel = new _model_filter__WEBPACK_IMPORTED_MODULE_13__["default"]();
...
const tripInfoPresenter = new _presenter_trip_info_js__WEBPACK_IMPORTED_MODULE_4__["default"](tripMainElement, pointsModel);
const menuPresenter = new _presenter_menu_js__WEBPACK_IMPORTED_MODULE_5__["default"](tripMainElement, newPointModel, menuModel, filterModel, pointsModel);
const eventPresenter = new _presenter_event_js__WEBPACK_IMPORTED_MODULE_0__["default"](tripEventsElement, pointsModel, filterModel, newPointModel, menuModel, offersModel, destinationsModel, apiWithProvider);
const statisticsPresenter = new _presenter_statistics_js__WEBPACK_IMPORTED_MODULE_6__["default"](statisticsElement, pointsModel, menuModel);
...
Promise.all(fetchedDataPromises)
  .then(([destinations, offers, points]) => {
    ...
    pointsModel.set(_const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].INIT, points);
  })
  .catch(() => {
    pointsModel.set(_const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].CRASH, []);
  });
...
class Filter extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    ...
    this._active = _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].EVERYTHING;
  }
...
class Menu extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();

    this._active = _const_js__WEBPACK_IMPORTED_MODULE_1__["TabNavItem"].TABLE;
  }
...
class NewPoint extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  }
...
/* harmony import */ var _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/observer.js */ "./src/utils/observer.js");
/* harmony import */ var _offers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./offers.js */ "./src/model/offers.js");
/* harmony import */ var _destinations_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./destinations.js */ "./src/model/destinations.js");




class Points extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._items = [];
  }
  ...
  static adaptToClient(point) {
    return Object.assign(
        {},
        {
          ...
          offers: point.offers.map((singleOffer) => _offers_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToClient(singleOffer)),
          destination: _destinations_js__WEBPACK_IMPORTED_MODULE_2__["default"].adaptToClient(point.destination),
  ...
  static adaptToServer(point) {
    return Object.assign(
        {},
        {
          ...
          "offers": point.offers.map((singleOffer) => _offers_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer(singleOffer)),
          "destination": _destinations_js__WEBPACK_IMPORTED_MODULE_2__["default"].adaptToServer(point.destination),
...
/* harmony import */ var _view_trip_days__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/trip-days */ "./src/view/trip-days.js");
/* harmony import */ var _view_event_msg_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/event-msg.js */ "./src/view/event-msg.js");
/* harmony import */ var _point_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./point.js */ "./src/presenter/point.js");
/* harmony import */ var _new_point_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./new-point.js */ "./src/presenter/new-point.js");
/* harmony import */ var _utils_trip_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/trip.js */ "./src/utils/trip.js");
...
class Event {
  constructor(tripEventsContainer, pointsModel, filterModel, newPointModel, menuModel, offersModel, destinationsModel, api) {
    ...
    this._currentSortType = _const_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].EVENT;
    ...
    this._newPointPresenter = new _new_point_js__WEBPACK_IMPORTED_MODULE_4__["default"](this._tripEventsContainer, newPointModel, this._handleViewAction);
  }
  ...
  _getPoints() {
    ...
    return this._pointsModel.get()
      .filter(Object(_utils_trip_js__WEBPACK_IMPORTED_MODULE_5__["getFilterRule"])(filterType))
      .sort(Object(_utils_trip_js__WEBPACK_IMPORTED_MODULE_5__["getSorterRule"])(this._currentSortType));
  }
  ...
  _renderSort() {
    ...
    this._eventSorterComponent = new _view_sort__WEBPACK_IMPORTED_MODULE_0__["default"](this._currentSortType);
    this._eventSorterComponent.setSortTypeChangeHandler(this._handleSortTypeChange);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(this._tripEventsContainer, this._eventSorterComponent);
  }
    ...
    switch (actionType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_6__["UserAction"].UPDATE_POINT:
        this._api.updatePoint(update)
          ...
          .catch(() => {
            this._pointStorage[update.id].setViewState(_const_js__WEBPACK_IMPORTED_MODULE_6__["State"].ABORTED);
          });
        break;
  ...
  _handleModelEvent(updateType, payload) {
    switch (updateType) {
      ...
      case _const_js__WEBPACK_IMPORTED_MODULE_6__["UpdateType"].MAJOR:
        const resetSortType = Object.values(_const_js__WEBPACK_IMPORTED_MODULE_6__["FilterType"]).includes(payload);
      ...
      case _const_js__WEBPACK_IMPORTED_MODULE_6__["UpdateType"].INIT:
        ...
        this._renderTripBoard();
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_6__["UpdateType"].CRASH:
        this._isLoading = false;
  ...
  _handleMenuEvent(_updateType, menuItem) {
    switch (menuItem.toLowerCase()) {
      case _const_js__WEBPACK_IMPORTED_MODULE_6__["TabNavItem"].TABLE.toLowerCase():
        this._clearTripBoard({resetSortType: true});
        this._renderTripBoard();
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_6__["TabNavItem"].STATISTICS.toLowerCase():
        this._clearTripBoard({resetSortType: true});
        break;
      default:
        break;
  ...
  _handleSortTypeChange(sortType) {
    ...
    if (sortType === _const_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].EVENT) {
  ...
  _renderMsg(msgText) {
    ...
    this._msgComponent = new _view_event_msg_js__WEBPACK_IMPORTED_MODULE_2__["default"](msgText);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(this._tripEventsContainer, this._msgComponent, _const_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].AFTERBEGIN);
  }

  _renderSinglePoint(pointContainer, tripEvent) {
    const point = new _point_js__WEBPACK_IMPORTED_MODULE_3__["default"](pointContainer, this._handleViewAction, this._handleModeChange);
  ...
  _renderEvents(sortedTripEvents) {
    const groupedEvents = Object(_utils_trip_js__WEBPACK_IMPORTED_MODULE_5__["groupEvents"])(this._currentSortType, sortedTripEvents);

    if (this._currentSortType === _const_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].EVENT) {
      Object.keys(groupedEvents).forEach((shortDay, dayIndex) => {
        const eventDay = Object(_utils_trip_js__WEBPACK_IMPORTED_MODULE_5__["convertToNullableDate"])(shortDay);
        const dayId = dayIndex + 1;
        const eventDayComponent = new _view_trip_days__WEBPACK_IMPORTED_MODULE_1__["default"](dayId, eventDay);
        this._dayStorage[dayId] = eventDayComponent;
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(this._tripEventsContainer, eventDayComponent);
    ...
    } else if (this._currentSortType === _const_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].TIME || this._currentSortType === _const_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].PRICE) {
      const eventDayComponent = new _view_trip_days__WEBPACK_IMPORTED_MODULE_1__["default"]();
  ...
  _clearEvents() {
    ...
    Object
      ...
      .forEach((day) => Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["remove"])(day));
  ...
  _renderTripBoard() {
    if (this._isLoading) {
      this._renderMsg(_const_js__WEBPACK_IMPORTED_MODULE_6__["MessageText"].LOADING);
      return;
    }

    if (this._isCrashed) {
      this._renderMsg(_const_js__WEBPACK_IMPORTED_MODULE_6__["MessageText"].CRASH);
      return;
    }

    if (!this._getPoints().length) {
      this._renderMsg(_const_js__WEBPACK_IMPORTED_MODULE_6__["MessageText"].NO_POINTS);
      return;
    }
  ...
  _clearTripBoard({resetSortType} = {}) {
    ...
    this._newPointPresenter.destroy();
    this._clearEvents();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._msgComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._eventSorterComponent);
  }
}
...
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _utils_trip_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/trip.js */ "./src/utils/trip.js");
...
class Filter {
  ...
  init() {
    ...
    this._filterComponent = new _view_filter_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._currentFilter, filters);
    this._filterComponent.setFilterTypeChangeHandler(this._handleFilterTypeChange);

    if (prevFilterComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filterContainer, this._filterComponent);
      return;
    }
  ...
  _handleFilterTypeChange(filterType) {
    ...
    this._filterModel.set(_const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MAJOR, filterType);
  }
  ...
  _getFilters() {
    ...
    Object
      .values(_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"])
      .forEach((filterTitle) => {
        filters[filterTitle] = points.some(Object(_utils_trip_js__WEBPACK_IMPORTED_MODULE_3__["getFilterRule"])(filterTitle));
      });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Menu; });
/* harmony import */ var _presenter_filter_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../presenter/filter.js */ "./src/presenter/filter.js");
/* harmony import */ var _view_menu_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/menu.js */ "./src/view/menu.js");
/* harmony import */ var _view_add_button__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/add-button */ "./src/view/add-button.js");
...
class Menu {
  constructor(menuContainer, newPointModel, menuModel, filterModel, pointsModel) {
    ...
    this._filterPresenter = new _presenter_filter_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._controlsContainer, filterModel, pointsModel);
  ...
  init() {
    this._tabsComponent = new _view_menu_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._menuModel.get());
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._tripConntrolsTitle, this._tabsComponent, _const_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].AFTEREND);

    this._buttonAddComponent = new _view_add_button__WEBPACK_IMPORTED_MODULE_2__["default"]();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._menuContainer, this._buttonAddComponent);
  ...
  _handleModelEvent(event, payload) {
    if (event === _const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"].MAJOR) {
  ...
  _handleMenuClick(menuItem) {
    switch (menuItem) {
      case _const_js__WEBPACK_IMPORTED_MODULE_4__["MenuItem"].ADD_NEW_EVENT:
        this._setActiveMenuItem(_const_js__WEBPACK_IMPORTED_MODULE_4__["MenuItem"].TABLE);
        this._filterPresenter.init();
        this._newPointModel.set(_const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"].MAJOR, menuItem);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_4__["MenuItem"].TABLE.toLowerCase():
        this._setActiveMenuItem(menuItem);
        this._filterPresenter.init();
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_4__["MenuItem"].STATISTICS.toLowerCase():
        this._setActiveMenuItem(menuItem);
  ...
  _setActiveMenuItem(tab) {
    if (this._filterModel.get() !== _const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"].EVERYTHING) {
      this._filterModel.set(_const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"].MAJOR, _const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"].EVERYTHING);
    }
    ...
    this._menuModel.set(_const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"].MAJOR, tab);
    this._tabsComponent.setActiveTab(tab);
  }

  _handlePointsModelEvent(event) {
    if (event === _const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"].INIT) {
      this._filterPresenter.init();
    }
  }
}
...
class NewPoint {
  ...
  init(destinations, tripOffers) {
    ...
    this._editorComponent = new _view_event_editor_js__WEBPACK_IMPORTED_MODULE_0__["default"](destinations, tripOffers);
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._pointContainer, this._editorComponent, _const_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].AFTERBEGIN);
  ...
  destroy() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._editorComponent);
    this._editorComponent = null;
  ...
  _handleFormSubmit(point) {
    this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"].ADD_POINT,
...
/* harmony import */ var _view_event_editor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/event-editor */ "./src/view/event-editor.js");
/* harmony import */ var _view_event__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/event */ "./src/view/event.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
...
class Point {
  constructor(pointContainer, changeData, changeMode) {
    ...
    this._editorComponent = null;
    this._mode = _const_js__WEBPACK_IMPORTED_MODULE_2__["PointMode"].DEFAULT;
  ...
  init(tripEvent, destinations, tripOffers) {
    ...
    this._pointComponent = new _view_event__WEBPACK_IMPORTED_MODULE_1__["default"](this._tripEvent);
    this._editorComponent = new _view_event_editor__WEBPACK_IMPORTED_MODULE_0__["default"](destinations, tripOffers, this._tripEvent);
    ...
    if (prevPointComponent === null || prevEditorComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._pointContainer, this._pointComponent);
      return;
    }

    if (this._mode === _const_js__WEBPACK_IMPORTED_MODULE_2__["PointMode"].DEFAULT) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._pointComponent, prevPointComponent);
    }

    if (this._mode === _const_js__WEBPACK_IMPORTED_MODULE_2__["PointMode"].EDITING) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._pointComponent, prevEditorComponent);
      this._mode = _const_js__WEBPACK_IMPORTED_MODULE_2__["PointMode"].DEFAULT;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(prevPointComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(prevEditorComponent);
  }

  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._pointComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._editorComponent);
  }
  ...
  replaceEditFormToPoint() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._pointComponent, this._editorComponent);
  ...
  setViewState(state) {
    ...
    switch (state) {
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["State"].SAVING:
        this._editorComponent.updateData({
          isDisabled: true,
          isSaving: true
        });
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["State"].DELETING:
        this._editorComponent.updateData({
          isDisabled: true,
          isDeleting: true
        });
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["State"].ABORTED:
  ...
  _replacePointToEditor() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._editorComponent, this._pointComponent);
    this._editorComponent.setDatePickers();
    document.addEventListener(`keydown`, this._escKeyDownHandler);
    this._changeMode();
    this._mode = _const_js__WEBPACK_IMPORTED_MODULE_2__["PointMode"].EDITING;
  }
  ...
  _handleDeleteClick() {
    this._changeData(_const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"].DELETE_POINT, _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MAJOR, this._tripEvent);
  }

  _handleFavoriteClick(updatedPoint) {
    this._changeData(_const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"].UPDATE_POINT, _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].PATCH, updatedPoint);
  }

  _handleFormSubmit(updatedPoint) {
    this._changeData(_const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"].UPDATE_POINT, _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MINOR, updatedPoint);
  }
}
...
/* harmony import */ var _view_statistics_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/statistics.js */ "./src/view/statistics.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
...
class Statistics {
  ...
  _renderStatistics() {
    ...
    this._statisticsComponent = new _view_statistics_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._pointsModel.get());
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._statisticsContainer, this._statisticsComponent, _const_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREBEGIN);
  }
  ...
  destroy() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._statisticsComponent);
    this._statisticsComponent = null;
  }

  _handleMenuEvent(_event, menuItem) {
    switch (menuItem) {
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["TabNavItem"].STATISTICS.toLowerCase():
...
class TripInfo {
  ...
  init() {
    ...
    this._tripInfoComponent = new _view_trip_info__WEBPACK_IMPORTED_MODULE_0__["default"](points);

    if (prevTripInfoComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._tripInfoContainer, this._tripInfoComponent, _const_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].AFTERBEGIN);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._tripInfoComponent, prevTripInfoComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(prevTripInfoComponent);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: toFirstUpperLetter, humanizeDuration */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toFirstUpperLetter", function() { return toFirstUpperLetter; });
...
const toFirstUpperLetter = (word) => {
  return word[0].toUpperCase() + word.slice(1, word.length);
};

const humanizeDuration = (finishDate, startDate) => {
  const startMoment = moment__WEBPACK_IMPORTED_MODULE_0___default()(finishDate)
    .subtract(finishDate.getSeconds(), `seconds`)
    .subtract(finishDate.getMilliseconds(), `milliseconds`);
  const finishMoment = moment__WEBPACK_IMPORTED_MODULE_0___default()(startDate)
    .subtract(startDate.getSeconds(), `seconds`)
    .subtract(startDate.getMilliseconds(), `milliseconds`);

  const duration = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(startMoment.diff(finishMoment));
...
const render = (container, child, place = _const_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND) => {
  ...
  switch (place) {
    ...
    case _const_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND:
      ...
      break;
    case _const_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTEREND:
      container.after(child);
      break;
    case _const_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREBEGIN:
...
/*!*********************************!*\
  !*** ./src/utils/statistics.js ***!
  \*********************************/
/*! exports provided: calculateStat */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "calculateStat", function() { return calculateStat; });
...
const extractValue = (event, statisticsType) => {
  ...
  switch (statisticsType) {
    case _const__WEBPACK_IMPORTED_MODULE_0__["StatisticsType"].MONEY:
      result += event.price;
      break;
    case _const__WEBPACK_IMPORTED_MODULE_0__["StatisticsType"].TRANSPORT:
      if (Object.values(_const__WEBPACK_IMPORTED_MODULE_0__["MoveType"]).includes(event.type)) {
        result++;
      } else {
        result = null;
      }
      break;
    case _const__WEBPACK_IMPORTED_MODULE_0__["StatisticsType"].TIME_SPENT:
      const startMoment = moment__WEBPACK_IMPORTED_MODULE_1___default()(event.startDate);
      const finishMoment = moment__WEBPACK_IMPORTED_MODULE_1___default()(event.endDate);
      result += moment__WEBPACK_IMPORTED_MODULE_1___default.a.duration(finishMoment.diff(startMoment));
  }
...
const roundResult = (rawValue, statisticsType) => {
  switch (statisticsType) {
    case _const__WEBPACK_IMPORTED_MODULE_0__["StatisticsType"].TIME_SPENT:
      return moment__WEBPACK_IMPORTED_MODULE_1___default.a.duration(rawValue).hours() + 1;
    default:
      return Math.round(rawValue);
  }
};

const calculateStat = (events, statisticsType) => {
...
/*!***************************!*\
  !*** ./src/utils/trip.js ***!
  \***************************/
/*! exports provided: eventTypePostfix, getSorterRule, getFilterRule, getTotalEventPrice, splitEventsByDays, splitEvents, convertToNullableDate, groupEvents, defineDestination, isPendingState */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "eventTypePostfix", function() { return eventTypePostfix; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSorterRule", function() { return getSorterRule; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFilterRule", function() { return getFilterRule; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTotalEventPrice", function() { return getTotalEventPrice; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "splitEventsByDays", function() { return splitEventsByDays; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "splitEvents", function() { return splitEvents; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "convertToNullableDate", function() { return convertToNullableDate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "groupEvents", function() { return groupEvents; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "defineDestination", function() { return defineDestination; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isPendingState", function() { return isPendingState; });
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
...
const eventTypePostfix = (eventType) => {
  return Object.values(_const_js__WEBPACK_IMPORTED_MODULE_1__["ActivityType"]).includes(eventType) ? _const_js__WEBPACK_IMPORTED_MODULE_1__["PostfixType"].ACTIVITY : _const_js__WEBPACK_IMPORTED_MODULE_1__["PostfixType"].MOVE;
};

const getSorterRule = (sortType) => {
  switch (sortType) {
    case _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT:
      return (a, b) => moment__WEBPACK_IMPORTED_MODULE_0___default()(a.startDate) - moment__WEBPACK_IMPORTED_MODULE_0___default()(b.startDate);
    case _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME:
      return (a, b) => {
        const durationA = moment__WEBPACK_IMPORTED_MODULE_0___default()(a.endDate).diff(moment__WEBPACK_IMPORTED_MODULE_0___default()(a.startDate));
        const durationB = moment__WEBPACK_IMPORTED_MODULE_0___default()(b.endDate).diff(moment__WEBPACK_IMPORTED_MODULE_0___default()(b.startDate));
        return durationB - durationA;
      };
    case _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE:
...
const getFilterRule = (filterType) => {
  switch (filterType) {
    case _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].FUTURE:
      return (event) => moment__WEBPACK_IMPORTED_MODULE_0___default()().isBefore(event.startDate);
    case _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].PAST:
      return (event) => moment__WEBPACK_IMPORTED_MODULE_0___default()().isAfter(event.endDate);
    default:
      return () => true;
  }
};

const getTotalEventPrice = (event) => {
...
const splitEventsByDays = (events) => {
  ...
  events.forEach((event) => {
    const shortDay = moment__WEBPACK_IMPORTED_MODULE_0___default()(event.startDate).format(`YYYY-MM-DD`);
...
const defineDestination = (destinations, selectedCity) => {
...
const isPendingState = (editState) => (editState < 0);
...
/***/ "./src/view/add-button.js":
/*!********************************!*\
  !*** ./src/view/add-button.js ***!
  \********************************/
/*! exports provided: createAddButtonTemplate, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createAddButtonTemplate", function() { return createAddButtonTemplate; });
...
const createAddButtonTemplate = () => {
  return (
    `<button class="trip-main__event-add-btn  btn  btn--big  btn--yellow"
             type="button"
             value="${_const_js__WEBPACK_IMPORTED_MODULE_1__["TabAdditionalItem"].ADD_NEW_EVENT}">
        New event
     </button>`
  );
};

class AddButton extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventEditor; });
...
/* harmony import */ var _node_modules_flatpickr_dist_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_node_modules_flatpickr_dist_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _utils_common__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/common */ "./src/utils/common.js");
/* harmony import */ var _smart_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./smart.js */ "./src/view/smart.js");
  ...
  return Object.values(selectedType).map((type) => (
    `<div class="event__type-item">
        ...
        <label class="event__type-label  event__type-label--${type.toLowerCase()}"
               for="event-type-${type}"
               data-type="${type}">
         ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_5__["toFirstUpperLetter"])(type)}
        </label>
      </div>`)).join(``);
};
...
const createDestinationItemsTemplate = (destinations, currentDestination, pointId) => {
  ...
  if (pointId === _const_js__WEBPACK_IMPORTED_MODULE_2__["POINT_ID"]) {
...
const createSubmitButtonTemplate = (isDisabled, editState) => {
  return (
    `<button class="event__save-btn  btn  btn--blue" type="submit"
      ${isDisabled ? `disabled` : ``}
    >
      ${editState === _const_js__WEBPACK_IMPORTED_MODULE_2__["State"].SAVING ? `Saving...` : `Save`}
    </button>`
  );
};
...
const createResetButtonTemplate = (pointId, isDisabled, editState) => {
  ...
  if (editState === _const_js__WEBPACK_IMPORTED_MODULE_2__["State"].DELETING) {
...
const createEditTripEventTemplate = (eventItem, destinations, offersList, editState) => {
  const isInterfaceDisabled = Object(_utils_trip_js__WEBPACK_IMPORTED_MODULE_3__["isPendingState"])(editState);
    ...
    `<form class="trip-events__item  event  event--edit" action="#" method="post">
      <header class="event__header">
        <div class="event__type-wrapper">
          ...
          <div class="event__type-list">
            <fieldset class="event__type-group">
              ...
              ${createEventTypesTemplate(_const_js__WEBPACK_IMPORTED_MODULE_2__["MoveType"])}
            </fieldset>
            <fieldset class="event__type-group">
              <legend class="visually-hidden">Activity</legend>
              ${createEventTypesTemplate(_const_js__WEBPACK_IMPORTED_MODULE_2__["ActivityType"])}
            </fieldset>
          </div>
        </div>
        <div class="event__field-group  event__field-group--destination">
          <label class="event__label  event__type-output" for="event-destination">
            ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_5__["toFirstUpperLetter"])(eventItem.type)} ${Object(_utils_trip_js__WEBPACK_IMPORTED_MODULE_3__["eventTypePostfix"])(eventItem.type)}
          </label>
        ...
        <div class="event__field-group  event__field-group--time">
          ...
          <input class="event__input  event__input--time" id="event-start-time" type="text" name="event-start-time" value="${moment__WEBPACK_IMPORTED_MODULE_1___default()(eventItem.startDate).format(`DD/MM/YY HH:mm`)}" ${isInterfaceDisabled ? `disabled` : ``}">
          —
          <label class="visually-hidden" for="event-end-time">
            To
          </label>
          <input class="event__input  event__input--time" id="event-end-time" type="text" name="event-end-time" value="${moment__WEBPACK_IMPORTED_MODULE_1___default()(eventItem.endDate).format(`DD/MM/YY HH:mm`)}" ${isInterfaceDisabled ? `disabled` : ``}">
        </div>
...
class EventEditor extends _smart_js__WEBPACK_IMPORTED_MODULE_6__["default"] {
  constructor(destinations = [], tripOffers = [], eventItem = _const_js__WEBPACK_IMPORTED_MODULE_2__["NEW_EVENT"]) {
    super();
    ...
    this._editState = _const_js__WEBPACK_IMPORTED_MODULE_2__["State"].DEFAULT;
  ...
  setDatePickers() {
    ...
    const eventStartDate = flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(
    ...
    const eventEndDate = flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(
  ...
  _destinationInputHandler(evt) {
    ...
    const updatedProperty = Object(_utils_trip_js__WEBPACK_IMPORTED_MODULE_3__["defineDestination"])(this._destinations, selectedCity);
  ...
  _formSubmitHandler(evt) {
    ...
    this.setEditState(_const_js__WEBPACK_IMPORTED_MODULE_2__["State"].SAVING);
    this._destroyDatePickers();
  ...
  _deleteClickHandler(evt) {
    evt.preventDefault();
    this._destroyDatePickers();
    this.setEditState(_const_js__WEBPACK_IMPORTED_MODULE_2__["State"].DELETING);
...
/***/ "./src/view/event-msg.js":
/*!*******************************!*\
  !*** ./src/view/event-msg.js ***!
  \*******************************/
/*! exports provided: createMsgTemplate, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createMsgTemplate", function() { return createMsgTemplate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventMsg; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
...
class EventMsg extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(msg) {
    super();
...
/* harmony import */ var _utils_trip_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/trip.js */ "./src/utils/trip.js");
...
const createOffersTemplate = (offers) => {
  ...
  const offerItems = offers
    .slice(0, _const__WEBPACK_IMPORTED_MODULE_4__["MAX_OFFERS"])
    ...
    `<li class="trip-events__item">
      <div class="event">
        ...
        <div class="event__schedule">
          <p class="event__time">
            <time class="event__start-time" datetime=${moment__WEBPACK_IMPORTED_MODULE_0___default()(event.startDate).format(`YYYY-MM-DD[T]HH:mm`)}>
             ${moment__WEBPACK_IMPORTED_MODULE_0___default()(event.startDate).format(`HH:mm`)}
            </time>
            —
            <time class="event__end-time" datetime=${moment__WEBPACK_IMPORTED_MODULE_0___default()(event.endDate).format(`YYYY-MM-DD[T]HH:mm`)}>
             ${moment__WEBPACK_IMPORTED_MODULE_0___default()(event.endDate).format(`HH:mm`)}
            </time>
          </p>
          <p class="event__duration">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["humanizeDuration"])(event.endDate, event.startDate)}</p>
        </div>
...
class Event extends _abstract_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
...
const createMenuTemplate = (currentTab) => {
  return Object
    .values(_const_js__WEBPACK_IMPORTED_MODULE_1__["TabNavItem"])
    .map((tab) => (
      `<a href="#"
...
class Menu extends _smart_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(initTab) {
    super();
    this._item = initTab;
...
const createEventSorterTemplate = (selectedSortType) => {
  ...
  const sortItemsTemplate = Object
    .values(_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"])
    .map((sortItem) =>
...
class EventSort extends _smart_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
const renderMoneyChart = (moneyCtx, tripEvents) => {
  const statData = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_4__["calculateStat"])(tripEvents, _const_js__WEBPACK_IMPORTED_MODULE_3__["StatisticsType"].MONEY);
...
const renderTransportChart = (transportCtx, tripEvents) => {
  const statData = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_4__["calculateStat"])(tripEvents, _const_js__WEBPACK_IMPORTED_MODULE_3__["StatisticsType"].TRANSPORT);
  const statLabel = Object.keys(statData).map((label) => label.toUpperCase().padStart(12));
...
const renderTimeSpendChart = (timeSpendCtx, tripEvents) => {
  const statData = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_4__["calculateStat"])(tripEvents, _const_js__WEBPACK_IMPORTED_MODULE_3__["StatisticsType"].TIME_SPENT);
  const statLabel = Object.keys(statData).map((label) => label.toUpperCase().padStart(12));
...
class Statistics extends _abstract_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripDays; });
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
...
const createDayInfoTemplate = (dayId, groupedDate) => {
  ...
  return (
    ...
    <time class="day__date" datetime="${moment__WEBPACK_IMPORTED_MODULE_0___default()(groupedDate).format(`YYYY-MM-DD`)}">${moment__WEBPACK_IMPORTED_MODULE_0___default()(groupedDate).format(`MMM DD`)}</time>`
  );
};
...
class TripDays extends _abstract_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
...
const createDatesTemplate = (sortedEvents) => {
  ...
  const isSameDay = moment__WEBPACK_IMPORTED_MODULE_0___default()(tripStartDate).isSame(tripFinishDate, `day`);
  const isSameMonth = moment__WEBPACK_IMPORTED_MODULE_0___default()(tripStartDate).isSame(tripFinishDate, `month`);
  const firstHumanizeDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(tripStartDate).format(`MMM DD`);
  ...
  if (isSameDay) {
    ...
    tripInfoDates = `${firstHumanizeDate}&nbsp;—&nbsp;${moment__WEBPACK_IMPORTED_MODULE_0___default()(tripFinishDate).format(`DD`)}`;
  } else {
    tripInfoDates = `${firstHumanizeDate}&nbsp;—&nbsp;${moment__WEBPACK_IMPORTED_MODULE_0___default()(tripFinishDate).format(`MMM DD`)}`;
  }
...
const createTripInfoTemplate = (tripEvents) => {
  ...
  const sortedEvents = tripEvents.sort(Object(_utils_trip_js__WEBPACK_IMPORTED_MODULE_2__["getSorterRule"])(_const_js__WEBPACK_IMPORTED_MODULE_3__["SortType"].EVENT));

  const cost = tripEvents.reduce((accumulatedSum, event) => accumulatedSum + Object(_utils_trip_js__WEBPACK_IMPORTED_MODULE_2__["getTotalEventPrice"])(event), 0);
